...
def create_my_dataset(data_path, batch_size=4, repeat_num=1):
    data_set = de.ImageFolderDataset(data_path, num_parallel_workers=8, shuffle=True)
    ...
    trans = [
        de.vision.Decode(),
        de.vision.Resize(image_size),
        de.vision.RandomHorizontalFlip(prob=0.5),#随机水平翻转
        
        de.vision.Normalize(mean=mean, std=std),
        de.vision.HWC2CHW()
    ]
